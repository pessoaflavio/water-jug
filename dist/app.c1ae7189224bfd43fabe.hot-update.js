...
function () {
  function RenderGift(opts) {
    ...
    self.loadModel(self.modelName).then(function (object) {
      ...
      self.scene = scene;
      self.scene.add(self.model); // self.getBoxGrid(self.number, 1)
  ...
  _createClass(RenderGift, [{
    key: "renderNumber",
    value: function renderNumber(amount, separationMultiplier) {
      var self = this;
      var x = 0,
          y = 0,
          max = 0;
...
//# sourceMappingURL=app.c1ae7189224bfd43fabe.hot-update.js.map