...
function () {
  function RenderGift(opts) {
    ...
    self.loadModel(self.modelName).then(function (object) {
      ...
      self.getBoxGrid(self.model, 25, 1); // end of experiment;
  ...
  _createClass(RenderGift, [{
    ...
    value: function getBoxGrid(model, amount, separationMultiplier) {
      ...
      for (var i = 0; i < amount; ++i) {
        ...
        obj.position.x = x * 2;
        obj.position.z = y * 2; // obj.position.y = y;
        // obj.position.y = 0;
    ...
    value: function getScene() {
      ...
      thisPlane.add(plane.position, 'x', -Math.PI, Math.PI);
      thisPlane.add(plane.position, 'y', -Math.PI, Math.PI);
      thisPlane.add(plane.position, 'z', -Math.PI, Math.PI);
      scene.add(plane);
      return scene;
    }
  }, {
...
//# sourceMappingURL=app.f9b5970b65c08de3bd24.hot-update.js.map