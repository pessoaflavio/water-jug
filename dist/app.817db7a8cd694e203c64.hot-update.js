...
function () {
  function RenderGift(opts) {
    ...
    self.loadModel(self.modelName).then(function (object) {
      ...
      self.getBoxGrid(self.model, 3, 2); // end of experiment;
    ...
    value: function getBoxGrid(model, amount, separationMultiplier) {
      ...
      for (var i = 0; i < amount; i++) {
        ...
        for (var j = 1; j < amount; j++) {
          ...
          obj.rotation.set(Math.PI / 8, Math.PI / 4, 0);
          obj.castShadow = true;
          obj.position.x = i * separationMultiplier; // obj.position.y = 0;
...
//# sourceMappingURL=app.817db7a8cd694e203c64.hot-update.js.map