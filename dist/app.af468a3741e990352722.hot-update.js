...
function () {
  function RenderGift(opts) {
    ...
    self.loadModel(self.modelName).then(function (object) {
      ...
      self.scene = scene;
      self.scene.add(self.model); // self.getBoxGrid(self.model, self.number, 1)
  ...
  _createClass(RenderGift, [{
    key: "getBoxGrid",
    value: function getBoxGrid(amount, separationMultiplier) {
      var self = this;
      var x = 0,
          y = 0,
          max = 0;
...
//# sourceMappingURL=app.af468a3741e990352722.hot-update.js.map