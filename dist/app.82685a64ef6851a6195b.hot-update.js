...
function () {
  function RenderGift(opts) {
    ...
    self.loadModel(self.modelName).then(function (object) {
      ...
      self.scene = scene;
      var items = self.getBoxGrid(object, self.scale, self.amount, 1);
      self.scene.add(items); // some experiment
  ...
  _createClass(RenderGift, [{
    key: "getBoxGrid",
    value: function getBoxGrid(model, scale, amount, separationMultiplier) {
...
//# sourceMappingURL=app.82685a64ef6851a6195b.hot-update.js.map