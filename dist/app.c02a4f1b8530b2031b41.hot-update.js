...
function () {
  function RenderGift(opts) {
    ...
    self.loadModel(self.modelName).then(function (object) {
      ...
      console.log(duplicate); // end of experiment
  ...
  _createClass(RenderGift, [{
    ...
    value: function getScene() {
      ...
      var spotLight = self.getSpotLight(0xffffff, 1, 100, Math.PI / 3);
...
//# sourceMappingURL=app.c02a4f1b8530b2031b41.hot-update.js.map